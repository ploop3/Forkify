...
import { Franction } from 'fractional'; //Destructuring so we don't call new Fraction.Fraction

class RecipeView {
  #parentElement = document.querySelector('.recipe');
  #data;
  #errorMessage = 'We could mot find that recipe. Please try another one';
  #message = '';
  ...
  #clear() {
    this.#parentElement.innerHTML = ''; //To remove the initial message
  }
